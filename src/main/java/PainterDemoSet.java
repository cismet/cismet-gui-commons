...
public class PainterDemoSet extends javax.swing.JFrame {
    ...
    public PainterDemoSet() {
        ...
        imageDemos();
        final ShapePainter star;
        shapeDemos();

        textDemos(gradient);

        final MattePainter gray = new MattePainter(Color.GRAY);
        rectangleDemos();
        transformDemos();
        addGlossDemos();
        addPinstripeDemos();
    ...
    private void loadCitations() throws Exception {
        p("doing citations");
        final URL url = this.getClass().getResource("/PainterDemoSet.java");
        ...
        while (scanner.hasNext()) {
            final String cite = scanner.next();
            // p("cite = " + cite);
            if (cite.contains("$name-")) {
                // p("contains");
                final String[] ret = regexSearch(cite, "\\$name-(.*?)-(.*)\\$endcite");
                // p("got: " + ret[1]);
                citeMap.put(ret[1], ret[2]);
                /*
                 * Pattern pat = Pattern.compile("\\$name-(.*)-(.*)\\$endcite",Pattern.DOTALL); Matcher matcher =
                 * pat.matcher(cite); matcher.find(); for(int i=0; i<=matcher.groupCount(); i++) { //p("got: " +
                 * matcher.group(i)); } citeMap.put(matcher.group(1),matcher.group(2));
                 */
     ...
     * @return  DOCUMENT ME!
     */
    private String[] regexSearch(final String source, final String pattern) {
        final Pattern pat = Pattern.compile(pattern, Pattern.DOTALL);
        final Matcher matcher = pat.matcher(source);
        matcher.find();
        final String[] list = new String[matcher.groupCount() + 1];
    ...
    private void miscDemos(final MultipleGradientPaint gradient) {
        ...
        final Font font2 = new Font("SansSerif", Font.BOLD, 80);
        final ShapePainter star;

        // a generated triangle with a gradient
        // $startcite
        // $name-misc01-
        final ShapePainter triangle = new ShapePainter(ShapeUtils.generatePolygon(3, 50, 30));
        ...
        final TextPainter coollogo = new TextPainter("Neon");
        coollogo.setFont(new Font("SansSerif", Font.BOLD, 100));
        coollogo.setFillPaint(Color.BLACK);
        final NeonBorderEffect neon1 = new NeonBorderEffect(Color.BLACK, Color.RED.brighter(), 10);
        ...
        final ShadowPathEffect starShadow = new ShadowPathEffect();
        ...
        final RectanglePainter rp = new RectanglePainter();
        // $endcite
    }
    ...
    private void tableDemos() {
        ...
        final JTable musicTable = createJTableWithData(false);
        // musicTable.setIntercellSpacing(new Dimension(0,0));
        musicTable.setGridColor(Color.GRAY.darker());
        // broken for now
        /*
         * PainterTableCellRenderer tableRenderer = new PainterTableCellRenderer(); MultipleGradientPaint shading = new
         * LinearGradientPaint(     new Point(0,0), new Point(0,10),     new float[] {0f, 1f} ,     new Color[]
         * {Color.GRAY, Color.GRAY.darker()}); tableRenderer.setBackgroundPainter(new MattePainter(shading)); shading =
         * new LinearGradientPaint(     new Point(0,0), new Point(0,10),     new float[] {0f, 1f} ,     new Color[]
         * {Color.BLUE, Color.BLUE.darker()});
         *
         * TextPainter selectionText = new TextPainter(); selectionText.setFillPaint(Color.BLACK);
         ...
         *
         * PainterTableCellRenderer headerRenderer = new PainterTableCellRenderer(); CompoundPainter headerPainter = new
         * CompoundPainter(     new MattePainter(new Color(200,200,200)),     new PinstripePainter(new
         * Color(220,220,220),45,5,8),     new RectanglePainter(new Color(200,200,200,0), Color.BLACK));
         * headerRenderer.setBackgroundPainter(headerPainter);
         *
         *
         * for(int i=0; i<musicTable.getColumnCount(); i++) { TableColumn col =
         * musicTable.getColumn(musicTable.getColumnName(i)); col.setHeaderRenderer(headerRenderer); }
         * //musicTable.setEnabled(false);
         *
         * musicTable.setRowSelectionAllowed(true); musicTable.setColumnSelectionAllowed(false); addDemo(new
         * JScrollPane(musicTable), "JTable with custom renderer","table01");//$endcite*/
    }
    ...
    private void transformDemos() {
        ...
        final RectanglePainter rectnorm;

        // affine transforms
        // $startcite
        // $name-trans01-
        final TextPainter normText = new TextPainter("Text", font2);
        ...
        // $startcite
        // $name-asdf-
        final TextPainter shearText = new TextPainter("Text", font2);
        ...
        // $startcite
        // $name-trans04-
        final TextPainter scaleText = new TextPainter("Text", font2);
    ...
    private void listDemos(final MultipleGradientPaint gradient) {
         ...
         * //$startcite //$name-list01- //a list with painter effects PainterListCellRenderer renderer = new
         * PainterListCellRenderer();
         *
         * // the list background RectanglePainter listRect = new RectanglePainter(1,1,1,1,10,10,true,
         * Color.RED.brighter(), 1, Color.RED.darker()); CompoundPainter listNormalBg = new CompoundPainter(     new
         * MattePainter(Color.WHITE),     listRect); renderer.setBackgroundPainter(listNormalBg);
         *
         * // the list foreground TextPainter listText = new TextPainter(); listText.setFillPaint(Color.WHITE);
         * listText.setHorizontalAlignment(TextPainter.HorizontalAlignment.LEFT); listText.setInsets(new
         * Insets(0,8,0,0));
         *
         * renderer.setForegroundPainter(listText);
         *
         * // the list selection Painter selectionPainter = new CompoundPainter(     new MattePainter(gradient),
         * listText); renderer.setSelectionPainter(selectionPainter);
         *
         * // set it on the list JList list = createJListWithData(); list.setCellRenderer(renderer); addDemo(list,"JList
         * with red bg + gradient selection","list01"); //$endcite
         *
         * //$startcite //$name-list02- // another list with normal even odds, plus reuse previous selection painter
         * PainterListCellRenderer evenodd = new PainterListCellRenderer() { public Component
         * getListCellRendererComponent(JList list, Object value,         int index, boolean isSelected, boolean
         * cellHasFocus) {     // initialize the renderer (which is 'this')     super.getListCellRendererComponent(list,
         * value,             index, isSelected, cellHasFocus);     setOpaque(true);     if(index % 2 == 0) {
         * setBackground(Color.WHITE);     } else {         setBackground(Color.LIGHT_GRAY);     }     return this; } };
         * evenodd.setSelectionPainter(selectionPainter); list = createJListWithData(); list.setCellRenderer(evenodd);
         * addDemo(list,"JList with even/odd + gradient selection","list02");//$endcite*/
    }
    ...
    private void rectangleDemos() {
        ...
        final RectanglePainter rectshad = createStandardRectPainter();
        final ShadowPathEffect rectShadEffect = new ShadowPathEffect();
        ...
        // $name-rect13-
        // rectangle with glow
        final RectanglePainter rectglow = createStandardRectPainter();
        ...
        final RectanglePainter rectinshad = new RectanglePainter(
                20,
                20,
                20,
                20,
                ...
                3,
                Color.GREEN.darker());
        final InnerShadowPathEffect rectinshadEffect = new InnerShadowPathEffect();
        rectinshad.setAreaEffects(rectinshadEffect);
        addDemo(new JXPanel(),
            new CompoundPainter(new MattePainter(Color.GRAY),
                rectinshad),
            "Rectangle with inner shadow",
            "rect14");
        // $endcite
        ...
        final RectanglePainter rectinglow = new RectanglePainter(
                20,
                20,
                20,
                20,
                ...
                3,
                Color.GREEN.darker());
        final InnerGlowPathEffect rectinglowEffect = new InnerGlowPathEffect();
        ...
        RectanglePainter rectneon = new RectanglePainter(
                20,
                20,
                20,
                20,
    ...
    private void textDemos(final MultipleGradientPaint gradient) {
        ...
        // normal text
        final Font font = new Font("SansSerif", Font.BOLD, 80);

        // $startcite
        // $name-text01-
        final TextPainter textnorm = new TextPainter("Neon", font, Color.RED);
        ...
        // $name-text11-
        // text w/ dropshadow
        final TextPainter textshadow = new TextPainter("Neon", font, Color.RED);
        ...
        // $name-text12-
        // text w/ glow effet
        final TextPainter textglow = new TextPainter("Neon", font, Color.RED);
        final GlowPathEffect glow = new GlowPathEffect();
        ...
        final TextPainter textinshad = new TextPainter("Neon", font, Color.RED);
        ...
        final TextPainter textinglow = new TextPainter("Neon", font, Color.RED);
    ...
    private void shapeDemos() {
        ...
        final Shape starShape = ShapeUtils.generatePolygon(5, 30, 15, true);
    ...
    private void addGlossDemos() {
        ...
        rect.setAntialiasing(true); // RectanglePainter.Antialiasing.On);
        addDemo(
            "broken: Gloss clipped on rectangle",
            "gloss02",
    ...
    private void addPinstripeDemos() {
        ...
        // $startcite
        // $name-pinstripe1-
        final MattePainter black = new MattePainter(Color.BLACK);
        final RectanglePainter rect = new RectanglePainter(
                20,
                20,
                20,
                20,
    ...
    private void addPainterSetAPIDemos() {
        ...
        // $name-painterset6-
        panel = new JXPanel();
        final AbstractPainter pt = new TextPainter("Some Text");
        ...
        final Painter compPainter = panel.getBackgroundPainter();
        final CompoundPainter comp = new CompoundPainter(compPainter);
        ...
        final Painter ptr = label.getForegroundPainter();
    ...
    private void imageDemos() {
        ...
        // $name-image02-
        try {
            final BufferedImage img = ImageIO.read(getClass().getResourceAsStream("border.gif"));
            final ImagePainter ip = new ImagePainter(img);
        ...
        // $name-image01-
        try {
            final BufferedImage img = ImageIO.read(getClass().getResourceAsStream("moon.jpg"));
            final ImagePainter ip = new ImagePainter(img);
        ...
        try {
            // $startcite
            // $name-image09-
            final BufferedImage img = ImageIO.read(getClass().getResourceAsStream("a-glyph.png"));
            final ImagePainter ip = new ImagePainter(img);
        ...
        try {
            ...
            ip.setImageString(
                "http://java.sun.com/developer/techDocs/hi/repository/graphicsRepository/toolbarButtonGraphics/general/Delete24.gif");
...
//        }
     ...
     */
    private void painterListValueChanged(final javax.swing.event.ListSelectionEvent evt) { //GEN-FIRST:event_painterListValueChanged
        final Demo demo = (Demo)painterList.getSelectedValue();
     ...
     */
    private void addDemo(final JComponent component, final Painter painter, final String string) {
     ...
     * @param  painter    DOCUMENT ME!
     * @param  string     DOCUMENT ME!
     * @param  citename   DOCUMENT ME!
     */
    private void addDemo(final JComponent component,
     ...
     * @param  string     DOCUMENT ME!
     */
    private void addDemo(final JComponent component, final String string) {
     ...
     * @param  citename   DOCUMENT ME!
     */
    private void addDemo(final JComponent component, final String string, final String citename) {
        ((DefaultListModel)painterList.getModel()).addElement(new Demo(component, string, citename));
    }
    /**
     * DOCUMENT ME!
     ...
     * @param  painters  DOCUMENT ME!
     */
    private void addDemo(final String text, final Painter... painters) {
     ...
     * @param  painters  DOCUMENT ME!
     */
    private void addDemo(final String text, final String citename, final Painter... painters) {
    ...
    private JList createJListWithData() {
        final String[] data = { "Item 1", "Item 2", "Item 3", "Item 4" };
    ...
    private JTable createJTableWithData(final boolean editable) {
        final String[] columns = { "Song", "Artist", "Album" };
        final String[][] data = {
    ...
    private void genericsDemos() {
        ...
        panel.setBackgroundPainter(new Painter<JXLabel>() {
                ...
                public void paint(final Graphics2D g, final JXLabel object, final int width, final int height) {
    ...
    private void addGradientDemos() {
        ...
        paint = new LinearGradientPaint(new Point(30, 30),
                new Point(80, 30),
                new float[] { 0f, 0.5f, 1f },
    ...
    private class Demo {
         ...
         */
        public Demo(final JComponent component, final String title) {
         ...
         * @param  component  DOCUMENT ME!
         * @param  title      DOCUMENT ME!
         * @param  citeid     DOCUMENT ME!
         */
        public Demo(final JComponent component, final String title, final String citeid) {
            this.component = component;
            this.title = title;
            this.citeid = citeid;
        }
