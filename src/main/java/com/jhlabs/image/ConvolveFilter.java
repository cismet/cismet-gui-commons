...
public class ConvolveFilter extends AbstractBufferedImageOp {
     ...
     */
    public static void convolve(final Kernel kernel,
            final int[] inPixels,
            final int[] outPixels,
            final int width,
            final int height,
     ...
     * @param  edgeAction  what to do at the edges
     */
    public static void convolveHV(final Kernel kernel,
            final int[] inPixels,
            final int[] outPixels,
            final int width,
            final int height,
     ...
     * @param  edgeAction  what to do at the edges
     */
    public static void convolveH(final Kernel kernel,
            final int[] inPixels,
            final int[] outPixels,
            final int width,
            final int height,
     ...
     * @param  edgeAction  what to do at the edges
     */
    public static void convolveV(final Kernel kernel,
            final int[] inPixels,
            final int[] outPixels,
            final int width,
            final int height,
