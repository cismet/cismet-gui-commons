...
public class LensBlurFilter extends AbstractBufferedImageOp {
    ...
    public BufferedImage filter(final BufferedImage src, BufferedImage dst) {
        ...
        final int adjustedWidth = (int)(width + (iradius * 2));
        final int adjustedHeight = (int)(height + (iradius * 2));
...
//                System.out.println("Tile: "+tileX+" "+tileY+" "+tileWidth+" "+tileHeight);
                ...
                // Create a float array from the pixels. Any pixels off the edge of the source image get duplicated
                // from the edge.
                i = 0;
                for (int y = 0; y < h; y++) {
