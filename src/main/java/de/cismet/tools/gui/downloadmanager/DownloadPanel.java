...
public class DownloadPanel extends javax.swing.JPanel implements Observer {
    ...
    private void initComponents() {
        ...
        mniOpenFile.setText(org.openide.util.NbBundle.getMessage(DownloadPanel.class, "DownloadPanel.mniOpenFile.text")); // NOI18N
        ...
        mniOpenDirectory.setText(org.openide.util.NbBundle.getMessage(DownloadPanel.class, "DownloadPanel.mniOpenDirectory.text")); // NOI18N
        ...
        lblIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/tools/gui/downloadmanager/documenttypes/fallback_single_32.png"))); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        prbProgress.setString(org.openide.util.NbBundle.getMessage(DownloadPanel.class, "DownloadPanel.prbProgress.string")); // NOI18N
        ...
        btnCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/tools/gui/downloadmanager/res/cross-circle.png_16x16.png"))); // NOI18N
        btnCancel.setText(org.openide.util.NbBundle.getMessage(DownloadPanel.class, "DownloadPanel.btnCancel.text")); // NOI18N
        btnCancel.setToolTipText(org.openide.util.NbBundle.getMessage(DownloadPanel.class, "DownloadPanel.btnCancel.toolTipText")); // NOI18N
        btnCancel.setBorderPainted(false);
        btnCancel.setContentAreaFilled(false);
        btnCancel.setFocusPainted(false);
        btnCancel.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/tools/gui/downloadmanager/res/cross-circle-frame.png_16x16.png"))); // NOI18N
