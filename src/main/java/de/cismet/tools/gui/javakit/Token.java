...
/**
 * Simple class to represent a lexical token. This wraps the Constants used by the scanner to provide a convenient class
 * that can be stored as a attribute value.
 *
...
public class Token implements Serializable {
    ...
    public static final Token NEWARRAY = new Operator(Constants.opNames[Constants.NEWARRAY],
            Constants.NEWARRAY);
    public static final Token NEWINSTANCE = new Operator(
            Constants.opNames[Constants.NEWINSTANCE],
            Constants.NEWINSTANCE);
    public static final Token NEWFROMNAME = new Operator(
            Constants.opNames[Constants.NEWFROMNAME],
    ...
    public static final Token METHOD = new Operator(Constants.opNames[Constants.METHOD],
            Constants.METHOD);
    public static final Token ARRAYACCESS = new Operator(
            Constants.opNames[Constants.ARRAYACCESS],
    ...
    public static final Token LENGTH = new Special(Constants.opNames[Constants.LENGTH],
            Constants.LENGTH);
    public static final Token INLINERETURN = new Special(
            Constants.opNames[Constants.INLINERETURN],
            Constants.INLINERETURN);
    public static final Token INLINEMETHOD = new Special(
            Constants.opNames[Constants.INLINEMETHOD],
     ...
     * @param  scanValue       DOCUMENT ME!
     */
    Token(final String representation, final int scanValue) {
    ...
    /**
     * Numeric value of this token. This is the value returned by the scanner and is the tie between the lexical scanner
     * and the tokens.
     *
     * @return  DOCUMENT ME!
     */
    ...
    public String getCategory() {
        final String nm = getClass().getName();
        final int nmStart = nm.lastIndexOf('.') + 1; // not found results in 0
    ...
    /**
     * Compares this object to the specifed object. The result is <code>true</code> if and only if the argument is not
     * <code>null</code> and is a <code>Font</code> object with the same name, style, and point size as this font.
     *
    ...
    public static class Operator extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Operator(final String representation, final int scanValue) {
    ...
    public static class Value extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Value(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Type extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Type(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Expression extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Expression(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Statement extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Statement(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Declaration extends Token {
        ...
        /**
         * Creates a new Declaration object.
         *
         * @param  representation  DOCUMENT ME!
         * @param  scanValue       DOCUMENT ME!
         */
        Declaration(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Modifier extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Modifier(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Punctuation extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Punctuation(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
    ...
    public static class Special extends Token {
         ...
         * @param  scanValue       DOCUMENT ME!
         */
        Special(final String representation, final int scanValue) {
            super(representation, scanValue);
        }
    }
